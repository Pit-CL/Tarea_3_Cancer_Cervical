...
# Podemos notar que no hay una mayor presencia de outliers.
...
print("Accuracy de entrenamiento regresión:", model_log.score(x_train,
                                                              y_train))
print("Accuracy de testeo regresión:", model_log.score(x_test, y_test))
...
print("Accuracy de entrenamiento SVC :", model_SVC.score(x_train, y_train))
print("Accuracy de testeo SVC :", model_SVC.score(x_test, y_test))
...
print("Accuracy de entrenamiento Random Forest :", model_Random.score(x_train,
                                                                      y_train))
print("Accuracy de testeo Random Forest :", model_Random.score(x_test, y_test))
...
# Calculando las accuracies
print("Accuracy de entrenamiento Árbol de decisión :", model_Tree.score(
    x_train, y_train))
print("Accuracy de testeo Árbol de decisión :", model_Tree.score(
    x_test, y_test))
...
# Calculando las accuracies
print("Accuracy de entrenamiento AdaBoost :", model_Boost.score(x_train,
                                                                y_train))
print("Accuracy de testeo AdaBoost :", model_Boost.score(x_test, y_test))
